...
>The warning told us that we lost information "piece" from row 49 which originally had two dashes. The last name was cut from the new database.
...
mpg_make_model <- mpg %>% # Start with mpg
  unite(col = make_model, # Create a new column called 'make_model'
        ...
        sep = "heygirlhey" # Puts "HEY!" between the pieces (default is underscore)
        ) 
...
some_dates <- c(04211989, 04221999, 04182009)
...
hookshots_by_month_gasol <- gasol_hookshots %>% 
  count(month)
